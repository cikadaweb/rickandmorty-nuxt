<template>
  <div 
    ...
    <h1 class="text-2xl sm:text-4xl">Эпизод: {{ episodeStore.getCurrentEpisode.name }} - {{ episodeStore.getCurrentEpisode.episode }}</h1>
    <div class="my-3 border-b-2 border-slate-300"></div>
    <h2 class="text-xl sm:text-3xl mt-5">Дата премьеры: {{ episodeStore.getCurrentEpisode.air_date }}</h2>
